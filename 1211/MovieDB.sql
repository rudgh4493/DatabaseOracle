...
Insert into MOVIEEXEC (NAME,ADDRESS,CERTNO,NETWORTH) values ('E1','hollywood',50,568445);
...
--------------------------------------------------------
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('M',2020,100,'t','disney',31);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('M',2021,150,'t','columbia',1);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('M',2022,100,'t','Amblin Entertainment',31);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('M',2023,100,'t','columbia',1);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('MZ1',2023,99,'t','fox',20);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('MZ2',2023,99,'t','disney',31);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('MZ3',2023,199,'t','disney',31);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('Kim''s World',2022,131,'t','mgm',2);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('Kim''s World',2023,131,'t','mgm',2);
Insert into MOVIE (TITLE,YEAR,LENGTH,INCOLOR,STUDIONAME,PRODUCERNO) values ('Kim''s World',2024,131,'t','mgm',2);
